...
export const canceledPurchaseRejectSchema = new mongoose.Schema(
  {
    ...
    cancelStartDate: { type: Date, required: [true, "취소 시작일이 없어요."] },
    rejectReason: { type: String, require: [true, "취소 거부 사유가 없어요."] },
...
const CanceledPurchaseReject =
  ...
  mongoose.model("CanceledPurchaseReject", canceledPurchaseRejectSchema);
