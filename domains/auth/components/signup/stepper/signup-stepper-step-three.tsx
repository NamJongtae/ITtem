import { useSignupIntroduceStatus } from '../../../hooks/signup/introduce-step/useSignupIntroduceStatus';

interface IProps {
  currentStep: "기본정보입력" | "프로필설정" | "소개글작성";
}

export default function SignupStepperStepThree({ currentStep }: IProps) {
