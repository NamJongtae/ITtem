...
import usePasswordValidation from "../../hooks/change-password/usePasswordValidation";
import CoreInputField from "@/components/core-input-field/core-input-field";

const ChangePasswordPasswordField = forwardRef<HTMLInputElement | null>(
  (props, ref) => {
...
ChangePasswordPasswordField.displayName = "ChangePasswordPwField";
export default ChangePasswordPasswordField;
