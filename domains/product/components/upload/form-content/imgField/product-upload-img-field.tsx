...
import ImgInput from "./product-upload-hidden-img-input";
import ProductUploadImgPreviewList from "./product-upload-img-preview-list";
import { ProductImgData } from "../../../../types/product-types";
import useProductUploadImgField from "@/domains/product/hooks/upload/img-field/useProductUploadimgField";
interface IProps {
