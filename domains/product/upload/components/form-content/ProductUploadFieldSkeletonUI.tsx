    ...
    <>
      ...
      <div className="border-b py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-5 mt-5">
          {[...Array(isEdit ? 5 : 1)].map((_, i) => (
            <div
              key={i}
              className="bg-gray-200 rounded-lg w-[192px] h-[192px] animate-pulse"
            />
          ))}
        </div>
      </div>
      ...
      <div className="border-b py-8">
        ...
        <div className="flex gap-2 mt-5">
          <div className="bg-gray-200 w-20 h-6 animate-pulse rounded" />
          <div className="bg-gray-200 w-20 h-6 animate-pulse rounded" />
        </div>
      </div>
      ...
      <div className="border-b py-8">
        ...
        <div className="flex gap-3 animate-pulse mt-5 ">
          <div className="bg-gray-200 w-20 h-[50px] rounded" />
          <div className="bg-gray-200 w-20 h-[50px] rounded" />
          <div className="bg-gray-200 w-20 h-[50px] rounded" />
        </div>

        <div className="bg-gray-200 w-full h-[50px] mt-3 animate-pulse" />
      </div>
      ...
      <div className="border-b py-8">
        ...
        <div className="flex flex-col gap-5 mt-5 animate-pulse">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="bg-gray-200 w-64 h-6 rounded" />
          ))}
        </div>
      </div>
      ...
      <div className="border-b py-8">
        ...
        <div className="flex gap-2 mt-5 animate-pulse">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="bg-gray-200 w-20 h-6 rounded" />
          ))}
        </div>
      </div>
      ...
      <div className="border-b py-8">
        ...
        <div className="bg-gray-200 rounded w-full max-w-[320px] h-[50px] mt-5 animate-pulse" />
      </div>
      ...
      <div className="border-b py-8">
        ...
        <div className="bg-gray-200 w-full h-56 mt-5 rounded animate-pulse" />
        <div className="flex justify-end animate-pulse">
          <div className="bg-gray-200 w-20 h-6 mt-[5px] ml-1 rounded" />
        </div>
      </div>
      ...
      <div className="flex justify-end gap-3 mt-5 animate-pulse">
        {[...Array(2)].map((_, i) => (
          <div key={i} className="bg-gray-200 w-[96px] h-[42px] rounded" />
        ))}
      </div>
    </>
  );
